...
const Testimonial = () => {
    return (
        <section id="testimonial">
            <div className="bg-man-cycle bg-no-repeat top-0 bg-center relative w-full min-h-screen  bg-cover font-sarabun  lg:padding-lg max-md:py-[45%] max-sm:py-[33%] text-white">

                <div className='w-[50%] max-md:w-full absolute translate-y-1 max-md:px-10'>
                    <div>
