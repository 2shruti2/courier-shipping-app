        ...
        <div className="bg-grey flex max-md:flex-col-reverse xs:p-10 sm:padding-lg font-sarabun "> 
            <div className="mt-10 grow-0 border-r-[1px] border-gray-400 ">
                <div className="pb-7 border-b-[1px] border-gray-400">
                    <h1 className="text-4xl font-bold pb-5 text-primary">Fast and reliable shipping services</h1>
            ...
            <div className=" pl-16 max-md:pl-0 pt-10 ">
                <img src="https://globefarer.qodeinteractive.com/wp-content/uploads/2021/08/main-home-img-1.jpg" alt="" />
            </div>
        </div>
